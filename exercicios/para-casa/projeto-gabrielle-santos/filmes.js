...
for (let i=0; i< obj.lenght; i++){
    let filmesmostrados = obj[i]
    console.log(filmesmostrados.Title)
    console.log(filmesmostrados.Year)
    console.log(filmesmostrados.Genre)

    //presente cada Genero em linhas separadas
    let generoMostrado = filmesmostrados.Genre
    let listadeGeneros = generoMostrado.split(",")
    console.log(listadeGeneros)
    for (let j=0; j<listadeGeneros.lenght; j++){
        console.table(listadeGeneros[j])
    }
}
