...
const mostreNoConsole = data.map((dado) => {

    let nome = dado.name;
    let descricao = dado.description;
    let endereco =  dado.art_url;
    let tipo = dado.types

    return console.log(nome, descricao, endereco, ...tipo)
})    

// Nesse eu também utilizei o map e usei o spread. 